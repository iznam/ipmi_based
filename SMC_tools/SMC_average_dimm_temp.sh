...
if test -e $HOME/Documents/Benchmarks/PMBus/$3.txt 
  then 
  rm $HOME/Documents/Benchmarks/PMBus/$3.txt
fi
...
cat <<EOF >> $HOME/Documents/Benchmarks/PMBus/$3.txt
$time $pcons $dimmTempAvrg1 $dimmTempAvrg2
EOF
time=$(( $time + 20 ))
sleep 15
done
